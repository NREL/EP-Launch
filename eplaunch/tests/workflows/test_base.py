import unittest
from eplaunch.workflows.base import EPLaunch3WorkflowResponse, BaseEPLaunch3Workflow


class TestWorkflowResponseConstruction(unittest.TestCase):

    def test_proper_construction(self):
        wfr = EPLaunch3WorkflowResponse(True, 'It is done', {'column1': 'data1'}, extra='data')
...
class TestBaseWorkflowMethods(unittest.TestCase):
    ...
    def setUp(self):
        self.base_workflow = BaseEPLaunch3Workflow()

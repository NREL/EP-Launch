...
The release of EP-Launch 3.0 in 2018 brought an entirely new codebase and an entirely new tool.
...
In addition, a new feature of EP-Launch 3.0 is the use of caches, which are small json files placed in working folders.
